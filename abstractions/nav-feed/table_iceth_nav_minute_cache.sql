...
-- drop table if exists dune_user_generated.indexcoop_iceth_nav_minute_cache  cascade
create table if not exists dune_user_generated.indexcoop_iceth_nav_minute_cache as
