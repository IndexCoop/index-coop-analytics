...
minutes as (
select generate_series(date_trunc('minute', '2022-11-01'::date), date_trunc('minute', now()), '1 minute') as minute
)
...
from    (
        ...
        from    (
                ...
                where       p1.minute >= date_trunc('minute', '2022-11-01'::date)
                and         p2.minute >= date_trunc('minute', '2022-11-01'::date) 
                ) t1
        ) t2
