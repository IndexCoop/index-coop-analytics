...
create table if not exists dune_user_generated.indexcoop_derivative_tokens
(
  symbol varchar,            
  base_symbol varchar,    
  protocol varchar,               
...
(symbol,            base_symbol,    protocol,               version,            token_address,                                          decimals,   token_type          ) values
