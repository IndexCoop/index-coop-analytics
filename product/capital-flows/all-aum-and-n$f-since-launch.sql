...
-- QUERY:       https://dune.xyz/queries/152571/301355
...
SELECT
    ...
    SUM(c.net_inflow) OVER (PARTITION BY c.name ORDER BY day ROWS BETWEEN 6 PRECEDING AND CURRENT ROW) / LAG(c.aum, 7) OVER (PARTITION BY c.name ORDER BY day) AS seven_day_flows
