-- https://duneanalytics.com/queries/64138/128652

-- v2 vs v3 Price Impact (WBTC:USDC)
...
select
            ...
            , '\xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48'::bytea as token1
            , '\x004375dff511095cc5a197a54140a24efef3a416'::bytea as pool
) 
...
select
            8 as dec0
            ,6 as dec1
            , '\x99ac8ca7087fa4a2a1fb6357269965a2014abc35'::bytea as pool
)
