...
WITH fli_uniswap_v3_supply AS (
    ...
    where       pool = '\x87d1b1A3675fF4ff6101926C1cCE971cd2D513eF'
    )
    ...
    -- Average daily reserves of BTC2X-FLI on Uniswap v3
    select
...
--btc2x sushi        x164FE0239d703379Bddde3c80e4d4800A1cd452B   
